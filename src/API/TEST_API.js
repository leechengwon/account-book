...
const ALL_DATA = [
  {
    ...
    amPm: '오후',
    classification: '이자',
    classificationSrc: '../account-book/images/Chip/side.png',
    asset: '은행',
    assetSrc: '../account-book/images/Chip/bank.png',
    memo: '은행이자',
  },
  {
    id: 2,
    ...
    amPm: '오후',
    classification: '금융소득',
    classificationSrc: '../account-book/images/Chip/finance.png',
    asset: '은행',
    assetSrc: '../account-book/images/Chip/bank.png',
    memo: '은행가서 입금해요',
  },
  {
    ...
    amPm: '오후',
    classification: '식비',
    classificationSrc: '../account-book/images/Chip/food.png',
    asset: '카드',
    assetSrc: '../account-book/images/Chip/credit_card.png',
    memo: '핫도그',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    amPm: '오전',
    classification: '월급',
    classificationSrc: '../account-book/images/Chip/salary.png',
    asset: '은행',
    assetSrc: '../account-book/images/Chip/bank.png',
    memo: '알바비',
  },
  {
    ...
    amPm: '오전',
    classification: '주거통신',
    classificationSrc: '../account-book/images/Chip/information.png',
    asset: '은행',
    assetSrc: '../account-book/images/Chip/bank.png',
    memo: '핸드폰비',
  },
  {
    ...
    amPm: '오전',
    classification: '패션미용',
    classificationSrc: '../account-book/images/Chip/fashion.png',
    memo: '파마',
    asset: '카드',
    assetSrc: '../account-book/images/Chip/credit_card.png',
  },
  ...
  },
  {
    ...
    amPm: '오전',
    classification: '경조사비',
    classificationSrc: '../account-book/images/Chip/celebration.png',
    asset: '현금',
    assetSrc: '../account-book/images/Chip/cash.png',
    memo: '결혼식 축의금',
  },
  {
    id: 10,
  ...
  },
  {
    ...
    amPm: '오전',
    classification: '교통차량',
    classificationSrc: '../account-book/images/Chip/car.png',
    asset: '카드',
    assetSrc: '../account-book/images/Chip/credit_card.png',
    memo: '주유비',
  },
  {
    ...
    amPm: '오전',
    classification: '건강',
    classificationSrc: '../account-book/images/Chip/health.png',
    asset: '현금',
    assetSrc: '../account-book/images/Chip/cash.png',
    memo: '헬스장 일일권',
  },
  {
    ...
    amPm: '오전',
    classification: '상여',
    classificationSrc: '../account-book/images/Chip/bonus.png',
    asset: '은행',
    assetSrc: '../account-book/images/Chip/bank.png',
    memo: '새해상여금',
  },
  {
    ...
    amPm: '오전',
    classification: '기타',
    classificationSrc: '../account-book/images/Chip/etc.png',
    memo: '빌려준돈을 받았다',
    asset: '현금',
    assetSrc: '../account-book/images/Chip/cash.png',
  },
  ...
  },
  {
    ...
    amPm: '오전',
    classification: '용돈',
    classificationSrc: '../account-book/images/Chip/pocket.png',
    asset: '현금',
    assetSrc: '../account-book/images/Chip/cash.png',
    memo: '현금',
  },
